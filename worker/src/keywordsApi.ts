...
// test. Stored and matched as the ENTIRE trimmed phrase, never split on
// whitespace - a multi-word keyword like "reddit media downloader" is
// one indivisible string from here all the way through to the
// extension's own matching code, precisely so it can never trigger on
// just "reddit" or "reddit media" appearing alone (explicit user
// requirement, 2026-09-04 - see keyword-blocker.js's own comment for
